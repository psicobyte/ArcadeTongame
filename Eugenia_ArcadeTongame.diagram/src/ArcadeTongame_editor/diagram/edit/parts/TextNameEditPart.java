 ...
 * @generated
 */
public class TextNameEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public TextNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorParserProvider
					.getParser(
							ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorElementTypes.Text_3003,
							getParserElement(),
							ArcadeTongame_editor.diagram.part.ArcadeTongame_editorVisualIDRegistry
									.getType(ArcadeTongame_editor.diagram.edit.parts.TextNameEditPart.VISUAL_ID));
		}
