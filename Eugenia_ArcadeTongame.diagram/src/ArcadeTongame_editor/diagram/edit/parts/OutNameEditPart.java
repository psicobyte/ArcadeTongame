 ...
 * @generated
 */
public class OutNameEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public OutNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorParserProvider
					.getParser(
							ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorElementTypes.Out_3005,
							getParserElement(),
							ArcadeTongame_editor.diagram.part.ArcadeTongame_editorVisualIDRegistry
									.getType(ArcadeTongame_editor.diagram.edit.parts.OutNameEditPart.VISUAL_ID));
		}
	...
	protected IFigure createFigurePrim() {
		return new OutLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OutLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OutLabelFigure() {
			this.setText("Out");
		}
