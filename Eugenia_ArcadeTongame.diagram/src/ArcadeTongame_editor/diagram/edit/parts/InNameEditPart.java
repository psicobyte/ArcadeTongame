 ...
 * @generated
 */
public class InNameEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public InNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorParserProvider
					.getParser(
							ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorElementTypes.In_3004,
							getParserElement(),
							ArcadeTongame_editor.diagram.part.ArcadeTongame_editorVisualIDRegistry
									.getType(ArcadeTongame_editor.diagram.edit.parts.InNameEditPart.VISUAL_ID));
		}
	...
	protected IFigure createFigurePrim() {
		return new InLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InLabelFigure() {
			this.setText("In");
		}
