 ...
 * @generated
 */
public class WallNameEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public WallNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorParserProvider
					.getParser(
							ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorElementTypes.Wall_3001,
							getParserElement(),
							ArcadeTongame_editor.diagram.part.ArcadeTongame_editorVisualIDRegistry
									.getType(ArcadeTongame_editor.diagram.edit.parts.WallNameEditPart.VISUAL_ID));
		}
	...
	protected IFigure createFigurePrim() {
		return new WallLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WallLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WallLabelFigure() {
			this.setText("Wall");
		}
