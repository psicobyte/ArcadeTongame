 ...
 * @generated
 */
public class SoundNameEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public SoundNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ArcadeTongame_editor.diagram.edit.policies.ArcadeTongame_editorTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorParserProvider
					.getParser(
							ArcadeTongame_editor.diagram.providers.ArcadeTongame_editorElementTypes.Sound_3002,
							getParserElement(),
							ArcadeTongame_editor.diagram.part.ArcadeTongame_editorVisualIDRegistry
									.getType(ArcadeTongame_editor.diagram.edit.parts.SoundNameEditPart.VISUAL_ID));
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					ArcadeTongame_editor.diagram.edit.parts.ArcadeTongame_editorEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new SoundLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SoundLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SoundLabelFigure() {
			this.setText("Sound");
		}
